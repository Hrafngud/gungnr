...
<template>
  <UiPanel as="article" variant="raise" class="flex flex-col h-full p-2">
      <UiButton class="w-36 text-center mb-2" :as="RouterLink" to="/host-settings" variant="ghost" size="sm">
        Template settings
      </UiButton>
    <div class="flex flex-1 flex-col gap-4">
      <div class="grid grid-cols-2 gap-4">
        <UiPanel
          ...
          class="flex flex-col gap-4 p-4 text-left transition"
